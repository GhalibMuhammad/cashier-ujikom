@if (Route::is(['sales.list']))
    ...
    <!-- Edit Adjustment -->
		<div class="modal fade" id="addjust-stock">
        ...
        <div class="modal fade" id="sales-modal-detail">
    ...
    <table class="table table-bordered align-middle">
        ...
        <tbody>
            <tr>
                <td>
                    <div class="d-flex align-items-center">
                        <img src="{{ URL::asset('/build/img/products/stock-img-02.png')}}" alt="product" style="width: 40px; height: 40px; object-fit: cover; margin-right: 10px;">
            ...
            <tr>
                <td>
                    <div class="d-flex align-items-center">
                        <img src="{{ URL::asset('/build/img/products/stock-img-03.png')}}" alt="product" style="width: 40px; height: 40px; object-fit: cover; margin-right: 10px;">
                        <span>Apple Series 5 Watch</span>
                    </div>
                </td>
                <td>2</td>
                <td>3000</td>
            ...
            <tr>
                <td>
                    <div class="d-flex align-items-center">
                        <img src="{{ URL::asset('/build/img/products/stock-img-05.png')}}" alt="product" style="width: 40px; height: 40px; object-fit: cover; margin-right: 10px;">
                        <span>Lobar Handy</span>
                    </div>
                </td>
                <td>2</td>
                <td>2500</td>
